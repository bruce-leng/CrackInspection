...
NewFileInclude2=#include "canvas.h"
LastPage=0

ClassCount=4
Class1=CDLineDlg1
Class2=CDLineDlg2
Class3=CDLineProperty
Class4=CTextEdit

ResourceCount=4
Resource1=IDD_DLG_SPECIALCHAR
Resource2=IDD_PROPPAGE_DLine1
Resource3=IDD_PROPPAGE_DLine2
Resource4=IDR_MENU_TEXTEDIT

[CLS:CDLineDlg1]
Type=0
BaseClass=CPropertyPage
HeaderFile=Graph\DLineDlg1.h
ImplementationFile=Graph\DLineDlg1.cpp
LastObject=CDLineDlg1

[CLS:CDLineDlg2]
Type=0
BaseClass=CPropertyPage
HeaderFile=Graph\DLineDlg2.h
ImplementationFile=Graph\DLineDlg2.cpp

[CLS:CDLineProperty]
Type=0
BaseClass=CPropertySheet
HeaderFile=Graph\DLineProperty.h
ImplementationFile=Graph\DLineProperty.cpp

[CLS:CTextEdit]
Type=0
BaseClass=CEdit
HeaderFile=Graph\TextEdit.h
ImplementationFile=Graph\TextEdit.cpp
Filter=W
VirtualFilter=WC
...
Type=1
Class=?
Command1=ID_UnDo_Text
Command2=ID_Cut
Command3=ID_Copy
Command4=ID_Past
Command5=ID_Delete
Command6=ID_INSERT_SPECIALCHAR
Command7=ID_SelectAll
Command8=ID_Move
Command9=ID_MENUITEM_Size
CommandCount=9

[DLG:IDD_DLG_SPECIALCHAR]
Type=1
Class=?
ControlCount=3
Control1=ID_INSERT,button,1342242817
Control2=IDCANCEL,button,1342242816
Control3=IDC_TAB1,SysTabControl32,1342177792
